...
class Args:
    def __init__(self):
        ...
        self.path = "/media/hcchen/307cc387-4594-4a7a-b426-1994a987f8c4/football_data/football_combined/fast"
        ...
        self.raw_video_path = "/media/hcchen/backup/DataCollection/CARLA_0.9.15/carla_combined"
