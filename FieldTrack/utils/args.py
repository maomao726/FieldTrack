...
def make_parser():
    ...
    parser.add_argument('--asso', default="mse", help="similarity function: mse/iou/giou/diou/ciou/ctdis")
    ...
    # for field detection
    parser.add_argument('--field_pretrained', type=str, default="/media/hcchen/data/MOTR/football_extension/best.pth", help="path to the field detection model")
    parser.add_argument('--field_input_size', type=tuple, default=(256, 256), help="input size for the field detection model")
    parser.add_argument('--raw_video_path', type=str, default="/media/hcchen/data/data/maincam_momentum", help="path to the raw video data")
