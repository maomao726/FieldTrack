...
class Format(Enum):
    ...
    FOOTBALL = 'football-mot'
    """Football MOT dataset format."""
    
def load_football_mot(fname, **kwargs):
    ...
    df = pd.read_csv(
        ...
        header=None,
        names=['FrameId', 'Id', 'X', 'Y', 'Confidence', 'Visibility']
    )
...
def loadtxt(fname, fmt=Format.MOT15_2D, **kwargs):
    ...
    switcher = {
        ...
        Format.FOOTBALL: load_football_mot,
    }
